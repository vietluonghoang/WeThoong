...
public class NetworkHandler extends AsyncTask<Void, Void, MessageContainer> {
    ...
    public NetworkHandler(String url, String callbackActionCase, int connectionTimeout) {
    ...
    public NetworkHandler(CallbackActivity parent, String url, String method, String mimeType, HashMap<String, String> payload, String callbackActionCase) {
        this.parent = parent;
        this.url = url;
        this.method = method;
    ...
    public NetworkHandler(CallbackActivity parent, String url, String method, String contentType, String mimeType, HashMap<String, String> payload, String callbackActionCase) {
        this.parent = parent;
        this.url = url;
        this.method = method;
    ...
    public NetworkHandler(CallbackActivity parent, String url, String method, String contentType, String mimeType, HashMap<String, String> payload, String callbackActionCase, int connectionTimeout) {
        this.parent = parent;
        this.url = url;
        this.method = method;
        this.contentType = contentType;
...
//            initResponseData(conn);
    ...
    @Override
    protected void onPostExecute(MessageContainer messages) {
